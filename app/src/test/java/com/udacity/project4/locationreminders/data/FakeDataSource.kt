...
class FakeDataSource : ReminderDataSource {
    //All my code was from the 3 testing lessons in the course and i made it by myself

 //its used if any exception with the database happened while fetching the data from it as maybe something unknown happened to the schema so we should catch the exception and send it to the viewmodel
